<!-- Coordinator Dashboard View (similar to faculty with extra overview) -->
  ...
  <div class="card">
    ...
    <div class="card-body">
      <div style="display:flex;flex-direction:column;gap:12px;">
        ...
        <a href="/reports/student_report.php" class="btn btn-secondary w-100" style="justify-content:flex-start">📄 Student Reports</a>
