...
<head>
    ...
    <title>Computer Science Engineering | Zeal College Academic Departments</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-icon-wrap">
            <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>
        </div>
...
<body>
    ...
    <section class="hero">
        ...
        <p>"Algorithms, systems programming, and foundational computer science principles."</p>
    </section>
    
    <div class="content-container">
        <h2>Department Overview</h2>
        <p>The Department of <strong>Computer Science Engineering</strong> represents the pinnacle of academic rigor and theoretical excellence at our institution. Founded on the principles of deep inquiry and practical application, the department has grown into a world-class center for research and education. Focus on core computation, system architecture, and theoretical computing.</p>
        ...
        <p>The curriculum for Computer Science Engineering is constantly evolving to reflect the latest advancements in the field while maintaining a strong grounding in core fundamentals. Students undergo rigorous training in both theoretical concepts and hands-on practical implementation.</p>
        ...
        <p>Research is at the heart of the Computer Science Engineering department. Our state-of-the-art laboratories are equipped with the latest technology, enabling students and faculty to push the boundaries of knowledge. We strongly encourage undergraduate students to participate in ongoing research projects, fostering a culture of innovation and intellectual curiosity.</p>
        ...
        <p>Graduates from the Computer Science Engineering department are highly sought after by top-tier corporations, research institutions, and government agencies worldwide. Our extensive alumni network provides invaluable mentorship and networking opportunities for current students.</p>
