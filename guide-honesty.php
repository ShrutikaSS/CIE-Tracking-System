...
<body>
    ...
    <section class="hero">
        ...
        <p>"Upholding the highest standards of integrity, ethics, and originality."</p>
    </section>
    
    <div class="content-container">
        <h2>Policy Overview</h2>
        <p>The policy of <strong>Academic Honesty</strong> represents a core pillar of the academic framework at Zeal College of Engineering & Research. By adhering to these principles, we maintain an environment of fairness, rigor, and respect for the scholarly process. Integrity is the foundation of all scholarly and professional endeavors.</p>
        ...
        <p>The specific protocols related to Academic Honesty are designed to provide clarity and remove ambiguity in the evaluation process. Students are encouraged to familiarize themselves with these protocols at the beginning of each academic semester.</p>
        ...
        <p>The rationale behind the strict enforcement of Academic Honesty extends beyond mere academic bookkeeping. It is fundamentally about character building. We view the academic journey as a crucible where the habits of professional life are forged.</p>
        ...
        <p>By leveraging technology, we ensure that the policy of Academic Honesty is applied universally and impartially across the entire institution.</p>
