...
<head>
    ...
    <title>Robotics & Automation | Zeal College Academic Departments</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-icon-wrap">
            <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>
        </div>
...
<body>
    ...
    <section class="hero">
        ...
        <p>"Evaluating robotics projects, automation systems, embedded controllers."</p>
    </section>
    
    <div class="content-container">
        <h2>Department Overview</h2>
        <p>The Department of <strong>Robotics & Automation</strong> represents the pinnacle of academic rigor and theoretical excellence at our institution. Founded on the principles of deep inquiry and practical application, the department has grown into a world-class center for research and education. Pioneering intelligent physical systems and industrial automation frameworks.</p>
        ...
        <p>The curriculum for Robotics & Automation is constantly evolving to reflect the latest advancements in the field while maintaining a strong grounding in core fundamentals. Students undergo rigorous training in both theoretical concepts and hands-on practical implementation.</p>
        ...
        <p>Graduates from the Robotics & Automation department are highly sought after by top-tier corporations, research institutions, and government agencies worldwide. Our extensive alumni network provides invaluable mentorship and networking opportunities for current students.</p>
