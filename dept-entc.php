...
<head>
    ...
    <title>Electronics & Telecommunication | Zeal College Academic Departments</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-icon-wrap">
            <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.55a11 11 0 0 1 14.08 0"></path><path d="M1.42 9a16 16 0 0 1 21.16 0"></path><path d="M8.53 16.11a6 6 0 0 1 6.95 0"></path><line x1="12" y1="20" x2="12.01" y2="20"></line></svg>
        </div>
...
<body>
    ...
    <section class="hero">
        ...
        <p>"Evaluating communication systems, signal processing, VLSI design."</p>
    </section>
    
    <div class="content-container">
        <h2>Department Overview</h2>
        <p>The Department of <strong>Electronics & Telecommunication</strong> represents the pinnacle of academic rigor and theoretical excellence at our institution. Founded on the principles of deep inquiry and practical application, the department has grown into a world-class center for research and education. Connecting the world through advanced signal processing and embedded design.</p>
        ...
        <p>The curriculum for Electronics & Telecommunication is constantly evolving to reflect the latest advancements in the field while maintaining a strong grounding in core fundamentals. Students undergo rigorous training in both theoretical concepts and hands-on practical implementation.</p>
        ...
        <p>Research is at the heart of the Electronics & Telecommunication department. Our state-of-the-art laboratories are equipped with the latest technology, enabling students and faculty to push the boundaries of knowledge. We strongly encourage undergraduate students to participate in ongoing research projects, fostering a culture of innovation and intellectual curiosity.</p>
        ...
        <p>Graduates from the Electronics & Telecommunication department are highly sought after by top-tier corporations, research institutions, and government agencies worldwide. Our extensive alumni network provides invaluable mentorship and networking opportunities for current students.</p>
