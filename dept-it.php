...
<head>
    ...
    <title>Information Technology | Zeal College Academic Departments</title>
...
<body>
    ...
    <section class="hero">
        ...
        <p>"Managing software development, web technologies, cloud computing."</p>
    </section>
    
    <div class="content-container">
        <h2>Department Overview</h2>
        <p>The Department of <strong>Information Technology</strong> represents the pinnacle of academic rigor and theoretical excellence at our institution. Founded on the principles of deep inquiry and practical application, the department has grown into a world-class center for research and education. Empowering the modern digital infrastructure and networked systems.</p>
        ...
        <p>The curriculum for Information Technology is constantly evolving to reflect the latest advancements in the field while maintaining a strong grounding in core fundamentals. Students undergo rigorous training in both theoretical concepts and hands-on practical implementation.</p>
        ...
        <p>Graduates from the Information Technology department are highly sought after by top-tier corporations, research institutions, and government agencies worldwide. Our extensive alumni network provides invaluable mentorship and networking opportunities for current students.</p>
